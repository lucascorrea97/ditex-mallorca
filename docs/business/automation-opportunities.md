...
| Live Price List / catalogue | #5/#7/#14 | Kills the A3 → Word → PDF → upload chain. Scale is >10k SKUs, not ~530. |
...
subset (all 10k vs tariff subset), the cut configurator, and the workshop cut sheet
